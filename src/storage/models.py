...
class Model(Base):
    ...
    request_format = Column(String, default='openai_compatible')
    response_text_path = Column(String, default='choices.0.message.content')
    usage_input_path = Column(String, default='usage.prompt_tokens')
    usage_output_path = Column(String, default='usage.completion_tokens')
